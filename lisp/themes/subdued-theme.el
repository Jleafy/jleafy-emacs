;; subdued-theme.el -- a tango-based color theme for Emacs
;; Revision 8
;;
;; Copyright (C) 2009-2010, 2016 Jason R. Blevins <jrblevin@sdf.org>
;; Copyright (C) 2013 Syohei YOSHIDA
;;
...
(custom-theme-set-faces
 ...
 '(cursor ((t (:foregound "#73d216")))) ; medium chameleon
